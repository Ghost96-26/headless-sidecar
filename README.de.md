...
- **Fehler-Backoff + Abkühlung**: Verbindungsfehler werden exponentiell zurückgestellt (4→8→… begrenzt durch `BACKOFF_MAX`); nach `FAIL_LIMIT` aufeinanderfolgenden Fehlern geht es in eine Abkühlphase und warnt nur einmal, statt das Log zu fluten.
